...
describe("resolveMarkdownFileLinkTarget", () => {
  ...
  it("formats tooltip display paths relative to the cwd when possible", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "file:///C:/Users/mike/dev-stuff/nitrocode/apps/web/src/session-logic.ts#L501",
        "C:/Users/mike/dev-stuff/nitrocode",
      ),
    ).toMatchObject({
      displayPath: "nitrocode/apps/web/src/session-logic.ts:501",
    });
  });
  ...
  it("formats tooltip display paths relative to the cwd for slash-prefixed windows paths", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "/C:/Users/mike/dev-stuff/nitrocode/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
        "C:/Users/mike/dev-stuff/nitrocode",
      ),
    ).toMatchObject({
      displayPath:
        "nitrocode/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
    });
  });
