...
export const PERSISTED_STATE_KEY = "nitrocode:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "nitrocode:renderer-state:v8",
  "nitrocode:renderer-state:v7",
  "nitrocode:renderer-state:v6",
  "nitrocode:renderer-state:v5",
  "nitrocode:renderer-state:v4",
  "nitrocode:renderer-state:v3",
