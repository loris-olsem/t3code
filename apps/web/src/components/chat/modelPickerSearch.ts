import { type ProviderKind, PROVIDER_DISPLAY_NAMES } from "@nitrocode/contracts";
import { normalizeSearchQuery, scoreQueryMatch } from "@nitrocode/shared/searchRanking";
