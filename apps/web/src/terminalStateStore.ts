...
import { parseScopedThreadKey, scopedThreadKey } from "@nitrocode/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@nitrocode/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "nitrocode:terminal-state:v1";
