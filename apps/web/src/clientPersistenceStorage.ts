...
export const CLIENT_SETTINGS_STORAGE_KEY = "nitrocode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "nitrocode:saved-environment-registry:v1";
