...
import { EDITORS, OpenError, type EditorId } from "@nitrocode/contracts";
import { isCommandAvailable, type CommandAvailabilityOptions } from "@nitrocode/shared/shell";
...
export { OpenError };
export { isCommandAvailable } from "@nitrocode/shared/shell";
 ...
 */
export class Open extends Context.Service<Open, OpenShape>()("nitrocode/open") {}
