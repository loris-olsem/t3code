 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@nitrocode/contracts";
...
>()("nitrocode/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
