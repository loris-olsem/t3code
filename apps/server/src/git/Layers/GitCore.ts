...
import { GitCommandError, type GitBranch } from "@nitrocode/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@nitrocode/shared/git";
...
import { decodeJsonResult } from "@nitrocode/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `nitrocode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
