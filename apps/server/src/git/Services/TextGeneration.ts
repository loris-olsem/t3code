...
import type { ChatAttachment, ModelSelection } from "@nitrocode/contracts";

import type { TextGenerationError } from "@nitrocode/contracts";
...
export class TextGeneration extends Context.Service<TextGeneration, TextGenerationShape>()(
  "nitrocode/git/Services/TextGeneration",
) {}
