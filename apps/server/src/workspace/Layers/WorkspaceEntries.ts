...
import { type FilesystemBrowseInput, type ProjectEntry } from "@nitrocode/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@nitrocode/shared/path";
import {
  insertRankedSearchResult,
  normalizeSearchQuery,
  scoreQueryMatch,
  type RankedSearchResult,
} from "@nitrocode/shared/searchRanking";
