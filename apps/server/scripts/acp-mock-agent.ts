...
const requestLogPath = process.env.NITROCODE_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.NITROCODE_ACP_EXIT_LOG_PATH;
const pidLogPath = process.env.NITROCODE_ACP_PID_LOG_PATH;
const emitToolCalls = process.env.NITROCODE_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.NITROCODE_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
const emitGenericToolPlaceholders =
  process.env.NITROCODE_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS === "1";
const emitAskQuestion = process.env.NITROCODE_ACP_EMIT_ASK_QUESTION === "1";
const failSetConfigOption = process.env.NITROCODE_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.NITROCODE_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.NITROCODE_ACP_PROMPT_RESPONSE_TEXT;
