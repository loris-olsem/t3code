// This file mostly exists because we want dev mode to say "NitroCode (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "NitroCode (Dev)" : "NitroCode (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.nitrocode.nitrocode.dev" : "com.nitrocode.nitrocode";
